...
function generateShapes(data) {
  ...
  function renderCircle (data) {
    ...
    <svg version="1.1" width="300" height="200">
      ...
      <text x="150" y="100" font-size="24" fill="${textColor}" text-anchor="middle" alignment-baseline="middle">${letters}</text>
    </svg>
    `
  }
  ...
  function renderSquare (data) {
    ...
    <svg version="1.1" width="300" height="200">
      ...
      <text x="150" y="125" font-size="24" fill="${textColor}" text-anchor="middle" dominant-baseline="middle">${letters}</text>
    </svg>
    `
  }
  ...
  function renderRectangle (data) {
    ...
    <svg version="1.1" width="300" height="200">
      ...
      <text x="150" y="100" font-size="24" fill="${textColor}" text-anchor="middle" dominant-baseline="middle">${letters}</text>
    </svg>
    `
  }
